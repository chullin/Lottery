...
class LotteryApp:
    def __init__(self, root):
        ...
        self.enlarge_button = tk.Button(root, text="結果字體放大", font=self.font, command=self.enlarge_font)
        self.enlarge_button.pack(pady=5)

        self.shrink_button = tk.Button(root, text="結果字體縮小", font=self.font, command=self.shrink_font)
        self.shrink_button.pack(pady=5)
